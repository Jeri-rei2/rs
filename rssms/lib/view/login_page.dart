...
import 'package:rssms/view/home_page.dart';
import 'package:rssms/widgets/dialogs.dart';
  ...
  doLogin(email, password) async {
    ...
    try {
      final response = await http.post(
          Uri.parse("https://rssurabayamedicalservice.rumahsakit.online/rssms/public/api/auth/login"),
